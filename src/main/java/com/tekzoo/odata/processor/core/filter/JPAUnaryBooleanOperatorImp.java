...
final class JPAUnaryBooleanOperatorImp implements JPAUnaryBooleanOperator {
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAUnaryBooleanOperator#get()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAUnaryBooleanOperator#getLeft()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAUnaryBooleanOperator#getOperator()
   */
  @Override
