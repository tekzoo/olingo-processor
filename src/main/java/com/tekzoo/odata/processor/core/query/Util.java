...
import static com.tekzoo.odata.metadata.core.edm.mapper.api.JPAPath.PATH_SEPARATOR;
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.NOT_SUPPORTED_RESOURCE_TYPE;
import static com.tekzoo.odata.processor.core.exception.ODataJPAUtilException.MessageKeys.UNKNOWN_ENTITY_TYPE;
import static com.tekzoo.odata.processor.core.exception.ODataJPAUtilException.MessageKeys.UNKNOWN_NAVI_PROPERTY;
...
import com.tekzoo.odata.processor.core.exception.ODataJPAUtilException;
...
public final class Util {
  ...
  public static Map<JPAExpandItem, JPAAssociationPath> determineAssociations(final JPAServiceDocument sd,
    ...
    if (startResourceList != null && expandOption != null) {
      ...
      // Example7 : ?$expand=BusinessPartner/com.tekzoo.odata.Person
