...
import com.tekzoo.odata.metadata.api.JPAEntityManagerFactory;
...
import com.tekzoo.odata.metadata.core.edm.mapper.impl.JPADefaultEdmNameBuilder;
import com.tekzoo.odata.processor.core.database.JPADefaultDatabaseProcessor;
import com.tekzoo.odata.processor.core.database.JPAODataDatabaseOperations;
import com.tekzoo.odata.processor.core.database.JPAODataDatabaseProcessorFactory;
...
public final class JPAODataServiceContext implements JPAODataSessionContextAccess {
  ...
  public static class Builder {
     ...
     * used, which uses the provided persistence-unit name ({@link Builder#setPUnit}) as
     * namespace.
     * @param nameBuilder
     * @return
     */
      ...
      if (emf.isPresent()) {
        try {
          final Class<? extends EntityManagerFactory> wrapperClass = (Class<? extends EntityManagerFactory>) Class
              .forName("com.tekzoo.odata.processor.cb.api.EntityManagerFactoryWrapper");
          if (jpaEdm == null)
            jpaEdm = new JPAEdmProvider(emf.get().getMetamodel(), postProcessor, packageName, nameBuilder);
