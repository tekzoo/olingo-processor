...
class JPAMethodCallImp implements JPAMethodCall {
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAFunctionCall#get()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAFunctionCall#get(String prefix, String suffix)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAFunctionCall#getFunction()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAFunctionCall#getParameter(int)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAFunctionCall#noParameters()
   */
  @Override
