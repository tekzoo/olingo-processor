...
class JPAArithmeticOperatorImp implements JPAArithmeticOperator {
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAArithmeticOperator#get()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAArithmeticOperator#getOperator()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAArithmeticOperator#getRight()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAArithmeticOperator#getRightAsExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAArithmeticOperator#getLeftAsIntExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPAArithmeticOperator#getRightAsIntExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
