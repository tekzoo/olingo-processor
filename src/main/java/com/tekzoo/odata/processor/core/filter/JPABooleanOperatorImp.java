...
class JPABooleanOperatorImp implements JPABooleanOperator {
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPABooleanOperator#get()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPABooleanOperator#getOperator()
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPABooleanOperator#getLeft()
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.tekzoo.odata.processor.core.filter.JPABooleanOperator#getRight()
   */
  @Override
