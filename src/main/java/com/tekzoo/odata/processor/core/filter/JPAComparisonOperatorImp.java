...
public class JPAComparisonOperatorImp<T extends Comparable<T>> implements JPAComparisonOperator<T> {
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAComparisonOperator#get()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAComparisonOperator#getOperator()
   */
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAComparisonOperator#getLeft()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAComparisonOperator#getRight()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAComparisonOperator#getRightAsComparable()
   */
  @Override
  @SuppressWarnings("unchecked")
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.processor.core.filter.JPAComparisonOperator#getRightAsExpression()
   */
  @Override
  @SuppressWarnings("unchecked")
