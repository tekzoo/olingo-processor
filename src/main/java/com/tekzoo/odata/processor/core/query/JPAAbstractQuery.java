...
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.MISSING_CLAIM;
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.MISSING_CLAIMS_PROVIDER;
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.QUERY_PREPARATION_ORDER_BY_TRANSIENT;
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.QUERY_RESULT_CONV_ERROR;
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.QUERY_RESULT_ENTITY_TYPE_ERROR;
import static com.tekzoo.odata.processor.core.exception.ODataJPAQueryException.MessageKeys.WILDCARD_UPPER_NOT_SUPPORTED;
...
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPADescriptionAttribute;
...
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAJoinTable;
...
import com.tekzoo.odata.processor.core.api.JPAClaimsPair;
...
import com.tekzoo.odata.processor.core.filter.JPAFilterComplier;
import com.tekzoo.odata.processor.core.processor.JPAEmptyDebugger;
...
public abstract class JPAAbstractQuery {
  ...
  protected List<Expression<?>> createGroupBy(final Map<String, From<?, ?>> joinTables,
  ...
  protected Expression<Boolean> createWhereByKey(final From<?, ?> root,
    ...
    Expression<Boolean> compoundCondition = null;

    if (keyPredicates != null) {
      for (final UriParameter keyPredicate : keyPredicates) {
        try {
          final Expression<Boolean> equalCondition =
  ...
  private Expression<Boolean> createProtectionWhereForAttribute(
    ...
    Expression<Boolean> attributeRestriction = null;
