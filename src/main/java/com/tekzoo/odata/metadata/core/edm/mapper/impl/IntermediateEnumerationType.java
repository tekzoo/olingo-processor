...
import com.tekzoo.odata.metadata.core.edm.annotation.EdmEnumeration.DummyConverter;
...
class IntermediateEnumerationType extends IntermediateModelElement implements JPAEnumerationAttribute {
  ...
  private EdmEnumeration getAnnotation() throws ODataJPAModelException {
    ...
    if (enumAnnotation == null)
      ...
      throw new ODataJPAModelException(MessageKeys.ENUMERATION_ANNOTATION_MISSING, javaEnum
          .getName());
