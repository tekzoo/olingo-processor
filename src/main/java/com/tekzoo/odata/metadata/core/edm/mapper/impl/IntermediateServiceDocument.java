...
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAAction;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAEdmNameBuilder;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAEntitySet;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAEntityType;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAEnumerationAttribute;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAFunction;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAProtectionInfo;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAServiceDocument;
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAStructuredType;
...
class IntermediateServiceDocument implements JPAServiceDocument {
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getAllSchemas()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getEdmEntityContainer()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getEdmSchemas()
   */
  @Override
   ...
   *
   * @see
   * com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntity(org.apache.olingo.commons.api.edm.
   * EdmType)
   */
  @Override
   ...
   *
   * @see
   * com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntity(java.lang.Class)
   */
  @Override
   ...
   *
   * @see
   * com.tekzoo.odata.metadata.core.edm.mapper.api.JPAServiceDocument#getComplexType(org.apache.olingo.commons.api.edm
   * .EdmComplexType)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntity(java.lang.String)
   */
  @Override
   ...
   *
   * @see
   * com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getEntitySet(com.tekzoo.odata.metadata.core.
   ...
   *
   * @see
   * com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getFunction(org.apache.olingo.commons.api.edm.
   * EdmFunction)
   */
  @Override
   ...
   *
   * @see
   * com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getAction(org.apache.olingo.commons.api.edm.
   * EdmFunction)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getReferences()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAServiceDocument#getTerm(org.apache.olingo.commons.api.edm.
   * FullQualifiedName)
   */
  @Override
