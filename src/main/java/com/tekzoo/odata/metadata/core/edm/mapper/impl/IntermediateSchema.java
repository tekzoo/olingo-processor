...
import com.tekzoo.odata.metadata.core.edm.annotation.EdmEnumeration;
...
//  edm:TypeDefinition
  ...
  JPAStructuredType getComplexType(final String externalName) {
    for (final Entry<String, IntermediateComplexType<?>> complexType : complexTypeListInternalKey.entrySet()) {
