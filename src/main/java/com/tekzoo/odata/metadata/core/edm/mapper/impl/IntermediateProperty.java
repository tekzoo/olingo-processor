...
import static com.tekzoo.odata.metadata.core.edm.mapper.exception.ODataJPAModelException.MessageKeys.COMPLEX_PROPERTY_MISSING_PROTECTION_PATH;
import static com.tekzoo.odata.metadata.core.edm.mapper.exception.ODataJPAModelException.MessageKeys.PROPERTY_PRECISION_NOT_IN_RANGE;
import static com.tekzoo.odata.metadata.core.edm.mapper.exception.ODataJPAModelException.MessageKeys.TRANSIENT_CALCULATOR_TOO_MANY_CONSTRUCTORS;
import static com.tekzoo.odata.metadata.core.edm.mapper.exception.ODataJPAModelException.MessageKeys.TRANSIENT_KEY_NOT_SUPPORTED;
...
import com.tekzoo.odata.metadata.core.edm.annotation.EdmGeospatial;
import com.tekzoo.odata.metadata.core.edm.annotation.EdmIgnore;
import com.tekzoo.odata.metadata.core.edm.annotation.EdmProtectedBy;
import com.tekzoo.odata.metadata.core.edm.annotation.EdmProtections;
import com.tekzoo.odata.metadata.core.edm.annotation.EdmSearchable;
...
import com.tekzoo.odata.metadata.core.edm.annotation.EdmVisibleFor;
...
import com.tekzoo.odata.metadata.core.edm.mapper.api.JPAParameter;
    ...
    if (jpaConverter != null) {
      try {
        ...
        throw new ODataJPAModelException(
            MessageKeys.TYPE_MAPPER_COULD_NOT_INSTANTIATED, e);
      }
    }
  }
