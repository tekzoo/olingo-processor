...
import com.tekzoo.odata.metadata.core.edm.annotation.EdmAnnotation;
...
import com.tekzoo.odata.metadata.core.edm.mapper.extension.IntermediateModelItemAccess;
...
abstract class IntermediateModelElement implements IntermediateModelItemAccess {
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.extension.IntermediateModelItemAccess#ignore()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.extension.IntermediateModelItemAccess#setIgnore(boolean)
   */
  @Override
