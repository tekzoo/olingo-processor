    ...
    if (parameterList == null) {
      ...
      for (int i = 0; i < declaredParameters.length; i++) {
        ...
        if (definedParameter == null)
          ...
          throw new ODataJPAModelException(MessageKeys.FUNC_PARAM_ANNOTATION_MISSING,
  ...
  protected FullQualifiedName determineParameterType(final Class<?> type,
    ...
    if (edmType != null)
      ...
      if (enumType != null) {
        ...
        throw new ODataJPAModelException(MessageKeys.FUNC_PARAM_ONLY_PRIMITIVE, javaFunction
