...
final class JPAAssociationPathImpl implements JPAAssociationPath {
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#getJoinColumnsList()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#getLeaf()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#getPath()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#getSourceType()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#getTargetType()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#isCollection()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAAssociationPath#hasJoinTable()
   */
  @Override
