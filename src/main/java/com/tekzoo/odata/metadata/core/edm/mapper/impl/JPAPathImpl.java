...
import static com.tekzoo.odata.metadata.core.edm.mapper.exception.ODataJPAModelException.MessageKeys.NOT_SUPPORTED_MIXED_PART_OF_GROUP;
...
final class JPAPathImpl implements JPAPath {
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAPath#getAlias()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAPath#getDBFieldName()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAPath#getLeaf()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAPath#getPath()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see com.tekzoo.odata.metadata.core.edm.mapper.impl.JPAPath#ignore()
   */
  @Override
